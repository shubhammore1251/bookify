				...
				<Row>
					<>
						...
						<Col xs="12" sm="6">
							...
							<h4 className="singleproduct-title">{data?.bname}</h4>
							{/* <img
								src={star}
								alt="star"
							...
							<div>
								<button className="hero-product-btn"  ><a href={data?.file} target="_blank" style={{ color: "#fff", textDecoration: "none" }}>Buy Now</a> </button>
