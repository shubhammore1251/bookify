        ...
        <>
            ...
            <Container>
                ...
                <div className="product-list-deals">
                    <h2 className="product-list-deals-h2" id="deals"> Question Papers </h2>
                    <p>Prepare yourself with our exclusive question papers set</p>
                    <p><strong>Free Download</strong></p>
                </div>
                <Row>
                    {product &&
                        product.slice(20, 26).map((list, key) => (
                            <Col xs="12" sm="3">
