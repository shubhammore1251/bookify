						...
						<Col xs="12" sm="4">
							...
							<div>
								...
								<div style={{ textAlign: "center" }}>
									<a href="https://twitter.com/Shriyash121?s=08" target="_blank">
										<FontAwesomeIcon
											icon={faTwitter}
											style={{
												fontSize: "30px",
									...
									{/* <a href="https://github.com/Shriyash-Jadhav" target="_blank">
										<FontAwesomeIcon
											icon={faGithub}
											style={{
												fontSize: "30px",
									...
									<a href="https://www.linkedin.com/in/shriyash-jadhav" target="_blank">
										<FontAwesomeIcon
											icon={faLinkedin}
											style={{
												fontSize: "30px",
									...
									<a href="https://wa.me/+919594522804" target="_blank">
										<FontAwesomeIcon
											icon={faWhatsapp}
											style={{
												fontSize: "30px",
									...
									<a href="https://www.facebook.com/shriyash.jadhav.79" target="_blank">
										<FontAwesomeIcon
											icon={faFacebook}
											style={{
												fontSize: "30px",
									...
									<a href="https://instagram.com/jadhav_shriyash?igshid=1l4rdki06oawp" target="_blank">
										<FontAwesomeIcon
											icon={faInstagram}
											style={{
												fontSize: "30px",
